...
import JusMangga from '../assets/jusmangga.png';
import JusAlpukat from '../assets/jusalpukat.jpg';
            ...
            <FlatList
              ...
              renderItem={({item}) => {
                ...
                const images = {
                  ...
                  jusmangga: JusMangga,
                  jusalpukat: JusAlpukat,
                };
                return (
                  <View style={styles.card}>
                    <Image
                      source={
                        images[item.title.replace(/\s+/g, '').toLowerCase()]
                      }
